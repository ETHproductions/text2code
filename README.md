...
(See folder [langs/text/](https://github.com/ETHproductions/text2code/tree/master/langs/text) for files.)

#### Programming languages
- JavaScript (experimental)
- Python 2 (experimental)

(See folder [langs/code/](https://github.com/ETHproductions/text2code/tree/master/langs/code) for files.)
